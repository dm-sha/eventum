...
const EventModal: React.FC<EventModalProps> = ({ event, isOpen, onClose }) => {
  ...
  const getLocationAddress = () => {
    ...
    // Ищем адрес у любой из локаций (effective_address уже содержит адрес ближайшего родителя)
    const locationWithAddress = event.locations.find(loc => loc.effective_address);
    return locationWithAddress?.effective_address || null;
  };
          ...
          <div className="p-6 space-y-6">
            ...
            <div>
              ...
              <div className="space-y-2">
                ...
                {getLocationAddress() && (
                  <div>
                    <div className="text-lg font-medium text-gray-900 mb-2">Адрес</div>
                    <div className="flex items-start text-gray-600">
                      <svg className="w-5 h-5 mr-2 mt-0.5 text-gray-400" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
